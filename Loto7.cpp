...
int main(int argc, char* argv[])
{
    ...
    layerManager.AddLayer(Loto7::dataKaigou * Loto7::dataNum, &sigmoid); // ì¸óÕëw 
    layerManager.AddLayer(400, &sigmoid);     // âBÇÍëw 
    layerManager.AddLayer(100, &sigmoid);     // âBÇÍëw 
    layerManager.AddLayer(Loto7::dataNum / 2, &sigmoid);      // èoóÕëw
